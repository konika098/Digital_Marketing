      ...
      <Container>
        <div className="hero__area">
          <Row className="align-items-center">
            <Col lg={7}>
              <img className="img-fluid" src="./assets/images/growth-1.png" alt="img" />
              ...
              <div className="client-img">
                <img className="img-fluid" src="./assets/images/clients.png" alt="img" />
              </div>
            </Col>

            <Col lg={5}>
              <div className="hero-left-side position-relative">
                <img className="img-fluid d-block d-xl-none" src="./assets/images/bg.png" alt="img" />
                <img className="img-fluid d-none d-xl-block" src="./assets/images/BG-1.png" alt="img" />
              </div>
